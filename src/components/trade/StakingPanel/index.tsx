    ...
    <div className="flex-1 overflow-y-auto p-6">
      <div className="bg-white/5 rounded-2xl p-6 mb-6 border border-transparent backdrop-blur-sm relative overflow-hidden">
        ...
        {!walletConnected ? (
          <button
            onClick={onConnect}
            className="bg-gradient-to-tr flex  from-purple-600 via-fuchsia-400 to-indigo-500 px-6 py-3 rounded-xl font-bold shadow-lg hover:scale-105 transition-all justify-center border border-transparent hover:border-fuchsia-300/50 shadow-purple-500/20"
          >
            Connect Wallet
          </button>
        ) : (
