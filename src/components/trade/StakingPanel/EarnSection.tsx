...
const EarnSection: React.FC<EarnSectionProps> = ({
  totalSupply,
  pools,
  highestAPR,
  recommended,
  ...
  return (
    <div className="bg-white/5 rounded-2xl p-6 mb-6 border border-fuchsia-400/30 inset-0 bg-gradient-to-br from-[#191633]/90 via-black/85 to-[#2b174a]/90">
      ...
      <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-fuchsia-300 to-indigo-300 bg-clip-text text-transparent">
        Recommended for you
      </h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {recommended.map((item, index) => (
          <div
            key={index}
            className="bg-gradient-to-br from-purple-500/30 via-fuchsia-500/30 to-indigo-500/30 p-4 rounded-xl shadow-md"
          >
