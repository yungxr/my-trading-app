      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div>
              <label className="block text-pink-300/80 text-sm mb-2">
                Coin Name
              </label>
              <input
                type="text"
            ...
            <table className="w-full">
              <thead>
                <tr className="text-left border-b border-white/10">
                  ...
                  <th className="pb-3 text-pink-300/80 font-medium text-right">
                    Price
                  </th>
                  <th className="pb-3 text-pink-300/80 font-medium text-right">
                    24h
                  ...
                  <th className="pb-3 pr-2 text-pink-300/80 font-medium text-right">
                    Updated
                  </th>
                </tr>
              </thead>
